...
public class MeUsrInterfaceService extends AbstractServiceLon<MeUsrInterface> {
    ...
    /**
     * private static String sql00 = "SELECT me_usr_interface.id as
     * me_usr_interface_id, me_usr_interface.pkey as me_usr_interface_pkey,
     * me_usr_interface.dc as me_usr_interface_dc, me_usr_interface.label as
     * me_usr_interface_label, me_usr_interface.level as me_usr_interface_level
     * FROM me_usr_interface ; "
     */
    @Override
...
//level    
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "me_usr_interface_level", nc++);
        return nc;
    }
