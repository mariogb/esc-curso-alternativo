...
public class ProgramJobService extends AbstractServiceLon<ProgramJob> {
     ...
     * program_job.pkey as program_job_pkey, program_job.description as
     * program_job_description, program_job.fast_key as program_job_fast_key,
     * program_job.nhoras as program_job_nhoras, program_job.pname as
     * program_job_pname, program.id as program_id,program.pkey as
     * program_pkey,program.pname as program_pname, departament_job.id as
     ...
     * departament_pkey,departament.pname as departament_pname FROM program_job,
     * program as program, departament_job as departament_job, departament as
     * departament WHERE program_job.program_id = program.id AND
     * program_job.departament_job_id = departament_job.id AND
...
//[2] departament --   departament
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "program_job_nhoras", nc++);     //pname       
