...
public class ComercialDocumentOutService extends AbstractServiceLon<ComercialDocumentOut> {
     ...
     * contract_pname, departament_base_time_period.id as
     ...
     * comercial_document_type_pname FROM comercial_document_out, contract_out
     * as contract, departament_base_time_period as
     * departament_base_time_period, base_time_period as base_time_period,
     * departament as departament, third_person as third_person, user_lon as
