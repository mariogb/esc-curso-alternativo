...
public class DepartamentJobInstanceService extends AbstractServiceLon<DepartamentJobInstance> {
    ...
    /**
     * private static String sql00 = "SELECT departament_job_instance.id as
     * departament_job_instance_id, departament_job_instance.pkey as
     * departament_job_instance_pkey, departament_job_instance.description as
     * departament_job_instance_description, departament_job_instance.nhoras as
     * departament_job_instance_nhoras, departament_job_instance.pname as
     * departament_job_instance_pname, departament_job.id as
     * departament_job_id,departament_job.pkey as
     * departament_job_pkey,departament_job.pname as departament_job_pname,
     * departament.id as departament_id, departament.pkey as
     * departament_pkey,departament.pname as departament_pname,
     * departament_base_time_period.id as
     ...
     * time_period.id as time_period_id, time_period.pkey as
     * time_period_pkey,time_period.pname as time_period_pname FROM
     * departament_job_instance, departament_job as departament_job, departament
     * as departament, departament_base_time_period as
     * departament_base_time_period, base_time_period as base_time_period, base
     * as base, time_period as time_period WHERE
     * departament_job_instance.departament_job_id = departament_job.id AND
     * departament_job.departament_id = departament.id AND
     * departament_job_instance.departament_base_time_period_id =
     * departament_base_time_period.id AND
     * departament_base_time_period.base_time_period_id = base_time_period.id
     * AND base_time_period.base_id = base.id AND
     * base_time_period.time_period_id = time_period.id; "
     */
    @Override
...
//[3] timePeriod --   timePeriod
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "departament_job_instance_nhoras", nc++);     //pname       
