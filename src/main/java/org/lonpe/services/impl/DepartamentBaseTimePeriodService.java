...
public class DepartamentBaseTimePeriodService extends AbstractServiceLon<DepartamentBaseTimePeriod> {
    ...
    /**
     * private static String sql00 = "SELECT departament_base_time_period.id as
     ...
     * as departament_pname FROM departament_base_time_period, base_time_period
     * as base_time_period, base as base, time_period as time_period,
     * departament as departament WHERE
     ...
     * departament_base_time_period.departament_id = departament.id; "
     */
    @Override
