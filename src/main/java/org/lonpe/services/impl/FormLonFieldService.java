...
public class FormLonFieldService extends AbstractServiceLon<FormLonField> {
    ...
    /**
     * private static String sql00 = "SELECT form_lon_field.id as
     * form_lon_field_id, form_lon_field.pkey as form_lon_field_pkey,
     * form_lon_field.pname as form_lon_field_pname, form_lon.id as
     * form_lon_id,form_lon.pkey as form_lon_pkey,form_lon.pname as
     * form_lon_pname FROM form_lon_field, form_lon as form_lon WHERE
