...
public class StockRackProductService extends AbstractServiceLon<StockRackProduct> {
    ...
    /**
     * private static String sql00 = "SELECT stock_rack_product.id as
     * stock_rack_product_id, stock_rack_product.pkey as
     * stock_rack_product_pkey, stock_rack_product.pname as
     * stock_rack_product_pname, stock_rack_product.quantity as
     * stock_rack_product_quantity, stock_rack_product.serial_number as
     * stock_rack_product_serial_number, stock_rack.id as
     * stock_rack_id,stock_rack.pkey as stock_rack_pkey,stock_rack.pname as
     * stock_rack_pname, work_space.id as work_space_id, work_space.pkey as
     * work_space_pkey,work_space.pname as work_space_pname, work_space_group.id
     * as work_space_group_id, work_space_group.pkey as
     * work_space_group_pkey,work_space_group.pname as work_space_group_pname,
     * product.id as product_id,product.pkey as product_pkey,product.pname as
     * product_pname, product_type.id as product_type_id, product_type.pkey as
     * product_type_pkey,product_type.pname as product_type_pname FROM
     * stock_rack_product, stock_rack as stock_rack, work_space as work_space,
     * work_space_group as work_space_group, product as product, product_type as
     * product_type WHERE stock_rack_product.stock_rack_id = stock_rack.id AND
     * stock_rack.work_space_id = work_space.id AND
     * work_space.work_space_group_id = work_space_group.id AND
     * stock_rack_product.product_id = product.id AND product.product_type_id =
     * product_type.id; "
     */
    @Override
...
//[3] workSpaceGroup --   workSpaceGroup
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        lToCell(r, row, "stock_rack_product_quantity", nc++);     //serialNumber       
