...
//[3] base --   base
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "appointment_end_hour", nc++);     //endMinute            
        iToCell(r, row, "appointment_end_minute", nc++);     //pname       
        sToCell(r, row, "appointment_pname", nc++);     //startHour            
        iToCell(r, row, "appointment_start_hour", nc++);     //startMinute            
        iToCell(r, row, "appointment_start_minute", nc++);     //weekDay            
        iToCell(r, row, "appointment_week_day", nc++);
//contract   contract        
        if (withIds) {
