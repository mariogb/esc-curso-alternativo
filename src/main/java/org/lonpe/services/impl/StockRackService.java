...
public class StockRackService extends AbstractServiceLon<StockRack> {
     ...
     * stock_rack.pkey as stock_rack_pkey, stock_rack.fast_key as
     * stock_rack_fast_key, stock_rack.pname as stock_rack_pname, work_space.id
     ...
     * base_pkey,base.pname as base_pname FROM stock_rack, work_space as
