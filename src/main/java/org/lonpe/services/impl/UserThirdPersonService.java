...
public class UserThirdPersonService extends AbstractServiceLon<UserThirdPerson> {
    ...
    /**
     * private static String sql00 = "SELECT user_third_person.id as
     * user_third_person_id, user_third_person.pkey as user_third_person_pkey,
     * user_lon.id as user_lon_id,user_lon.pkey as user_lon_pkey,user_lon.pname
     * as user_lon_pname, third_person.id as third_person_id,third_person.pkey
     * as third_person_pkey,third_person.pname as third_person_pname FROM
     * user_third_person, user_lon as user_lon, third_person as third_person
     * WHERE user_third_person.user_lon_id = user_lon.id AND
     * user_third_person.third_person_id = third_person.id; "
     */
    @Override
