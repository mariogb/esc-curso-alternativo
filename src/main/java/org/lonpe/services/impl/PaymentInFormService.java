...
public class PaymentInFormService extends AbstractServiceLon<PaymentInForm> {
    ...
    /**
     * private static String sql00 = "SELECT payment_in_form.id as
     ...
     * payment_in_type_pkey,payment_in_type.pname as payment_in_type_pname FROM
     * payment_in_form, monetary_account as monetary_account, payment_in_type as
     * payment_in_type WHERE payment_in_form.monetary_account_id =
     * monetary_account.id AND payment_in_form.payment_in_type_id =
     * payment_in_type.id; "
     */
    @Override
