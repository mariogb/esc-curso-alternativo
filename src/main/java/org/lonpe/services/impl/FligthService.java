...
public class FligthService extends AbstractServiceLon<Fligth> {
    ...
    /**
     * private static String sql00 = "SELECT fligth.id as fligth_id, fligth.pkey
     * as fligth_pkey, fligth.pname as fligth_pname, from_airport.id as
     * from_airport_id,from_airport.pkey as from_airport_pkey,from_airport.pname
     * as from_airport_pname, to_airport.id as to_airport_id,to_airport.pkey as
     * to_airport_pkey,to_airport.pname as to_airport_pname, plane.id as
     * plane_id,plane.pkey as plane_pkey,plane.pname as plane_pname,
     * la_compania.id as la_compania_id, la_compania.pkey as
     * la_compania_pkey,la_compania.pname as la_compania_pname FROM fligth,
     * airport as from_airport, airport as to_airport, plane as plane,
     * air_company as la_compania WHERE fligth.from_airport_id = from_airport.id
     * AND fligth.to_airport_id = to_airport.id AND fligth.plane_id = plane.id
