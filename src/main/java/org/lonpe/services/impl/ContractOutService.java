...
public class ContractOutService extends AbstractServiceLon<ContractOut> {
     ...
     * contract_out.pkey as contract_out_pkey, contract_out.pname as
     * contract_out_pname, departament_base_time_period.id as
     ...
     * time_period_pkey,time_period.pname as time_period_pname, departament.id
     * as departament_id, departament.pkey as departament_pkey,departament.pname
     * as departament_pname, third_person.id as
     * third_person_id,third_person.pkey as third_person_pkey,third_person.pname
     * as third_person_pname FROM contract_out, departament_base_time_period as
     * departament_base_time_period, base_time_period as base_time_period, base
     * as base, time_period as time_period, departament as departament,
     * third_person as third_person WHERE
     * contract_out.departament_base_time_period_id =
     ...
     * base_time_period.time_period_id = time_period.id AND
     * departament_base_time_period.departament_id = departament.id AND
     * contract_out.third_person_id = third_person.id; "
     */
    @Override
