...
public class UserLonService extends AbstractServiceLon<UserLon> {
     ...
     * user_lon.pkey as user_lon_pkey, user_lon.email as user_lon_email,
     * user_lon.enabled as user_lon_enabled, user_lon.pname as user_lon_pname,
     * user_lon.type_lon as user_lon_type_lon, user_lon.username as
     * user_lon_username FROM user_lon ; "
     */
    @Override
