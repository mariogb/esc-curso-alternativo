...
public class BaseUserLonService extends AbstractServiceLon<BaseUserLon> {
    ...
    /**
     * private static String sql00 = "SELECT base_user_lon.id as
     * base_user_lon_id, base_user_lon.pkey as base_user_lon_pkey, base.id as
     * base_id,base.pkey as base_pkey,base.pname as base_pname, user_lon.id as
     * user_lon_id,user_lon.pkey as user_lon_pkey,user_lon.pname as
     * user_lon_pname FROM base_user_lon, base as base, user_lon as user_lon
     * WHERE base_user_lon.base_id = base.id AND base_user_lon.user_lon_id =
     * user_lon.id; "
     */
    @Override
