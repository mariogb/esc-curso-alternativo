...
public class UserRoleService extends AbstractServiceLon<UserRole> {
     ...
     * user_role.pkey as user_role_pkey, user_lon.id as
     * user_lon_id,user_lon.pkey as user_lon_pkey,user_lon.pname as
     * user_lon_pname, role.id as role_id,role.pkey as role_pkey,role.pname as
     * role_pname FROM user_role, user_lon as user_lon, role as role WHERE
     * user_role.user_lon_id = user_lon.id AND user_role.role_id = role.id; "
     */
    @Override
