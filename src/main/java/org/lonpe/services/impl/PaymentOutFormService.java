...
public class PaymentOutFormService extends AbstractServiceLon<PaymentOutForm> {
    ...
    /**
     * private static String sql00 = "SELECT payment_out_form.id as
     ...
     * payment_out_type as payment_out_type WHERE
     * payment_out_form.monetary_account_id = monetary_account.id AND
     * payment_out_form.payment_out_type_id = payment_out_type.id; "
     */
    @Override
