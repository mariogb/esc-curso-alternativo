...
public class InvoiceLineInService extends AbstractServiceLon<InvoiceLineIn> {
    ...
    /**
     * private static String sql00 = "SELECT invoice_line_in.id as
     * invoice_line_in_id, invoice_line_in.pkey as invoice_line_in_pkey,
     ...
     * invoice_line_in.orden as invoice_line_in_orden, invoice_line_in.status as
     * invoice_line_in_status, invoice_line_in.supply_date as
     * invoice_line_in_supply_date, invoice_line_in.supply_quantity as
     * invoice_line_in_supply_quantity, invoice_line_in.tax_porcent as
     * invoice_line_in_tax_porcent, invoice_line_in.total as
     * invoice_line_in_total, invoice_line_in.total_cost as
     * invoice_line_in_total_cost, invoice_line_in.unit_cost as
     * invoice_line_in_unit_cost, comercial_document.id as
     ...
     * work_space_pname FROM invoice_line_in, comercial_document_out as
     * comercial_document, contract_out as contract,
     * departament_base_time_period as departament_base_time_period,
     * third_person as third_person, user_lon as user_autor,
     * comercial_document_type_out as comercial_document_type, product as
     * product, product_type as product_type, stock_rack_product as
     * stock_rack_product, stock_rack as stock_rack, work_space as work_space
     * WHERE invoice_line_in.comercial_document_id = comercial_document.id AND
     ...
     * third_person.id AND comercial_document.user_autor_id = user_autor.id AND
     * comercial_document.comercial_document_type_id =
     * comercial_document_type.id AND invoice_line_in.product_id = product.id
     * AND product.product_type_id = product_type.id AND
     * invoice_line_in.stock_rack_product_id = stock_rack_product.id AND
...
//[3] workSpace --   workSpace
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "invoice_line_in_orden", nc++);     //status       
