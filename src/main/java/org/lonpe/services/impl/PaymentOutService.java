...
public class PaymentOutService extends AbstractServiceLon<PaymentOut> {
     ...
     * payment_out_type.id as payment_out_type_id, payment_out_type.pkey as
     ...
     * comercial_document_out_pname, contract.id as contract_id, contract.pkey
     * as contract_pkey,contract.pname as contract_pname,
     ...
     * comercial_document_type_pname FROM payment_out, payment_out_form as
     * payment_out_form, monetary_account as monetary_account, payment_out_type
     * as payment_out_type, comercial_document_out as comercial_document_out,
     * contract_out as contract, departament_base_time_period as
     * departament_base_time_period, third_person as third_person, user_lon as
     * user_autor, comercial_document_type_out as comercial_document_type WHERE
     * payment_out.payment_out_form_id = payment_out_form.id AND
     * payment_out_form.monetary_account_id = monetary_account.id AND
     * payment_out_form.payment_out_type_id = payment_out_type.id AND
     * payment_out.comercial_document_out_id = comercial_document_out.id AND
     ...
     * third_person.id AND comercial_document_out.user_autor_id = user_autor.id
     * AND comercial_document_out.comercial_document_type_id =
