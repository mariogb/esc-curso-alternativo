...
public class ContractInService extends AbstractServiceLon<ContractIn> {
     ...
     * contract_in.pkey as contract_in_pkey, contract_in.pname as
     * contract_in_pname, program_base_time_period.id as
     ...
     * time_period_pkey,time_period.pname as time_period_pname, program.id as
     * program_id, program.pkey as program_pkey,program.pname as program_pname,
     * third_person.id as third_person_id,third_person.pkey as
     * third_person_pkey,third_person.pname as third_person_pname FROM
     * contract_in, program_base_time_period as program_base_time_period,
     * base_time_period as base_time_period, base as base, time_period as
     * time_period, program as program, third_person as third_person WHERE
     * contract_in.program_base_time_period_id = program_base_time_period.id AND
     * program_base_time_period.base_time_period_id = base_time_period.id AND
     * base_time_period.base_id = base.id AND base_time_period.time_period_id =
     * time_period.id AND program_base_time_period.program_id = program.id AND
     * contract_in.third_person_id = third_person.id; "
     */
    @Override
