...
public class DepartamentJobService extends AbstractServiceLon<DepartamentJob> {
    ...
    /**
     * private static String sql00 = "SELECT departament_job.id as
     * departament_job_id, departament_job.pkey as departament_job_pkey,
     * departament_job.description as departament_job_description,
     * departament_job.fast_key as departament_job_fast_key,
     * departament_job.nhoras as departament_job_nhoras, departament_job.pname
     * as departament_job_pname, departament.id as
     * departament_id,departament.pkey as departament_pkey,departament.pname as
     * departament_pname FROM departament_job, departament as departament WHERE
...
// departament   departament
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        iToCell(r, row, "departament_job_nhoras", nc++);     //pname       
