...
public class ComercialDocumentInService extends AbstractServiceLon<ComercialDocumentIn> {
    ...
    /**
     * private static String sql00 = "SELECT comercial_document_in.id as
     * comercial_document_in_id, comercial_document_in.pkey as
     * comercial_document_in_pkey, comercial_document_in.created_date as
     * comercial_document_in_created_date, comercial_document_in.document_date
     * as comercial_document_in_document_date, comercial_document_in.folio as
     * comercial_document_in_folio, comercial_document_in.pname as
     * comercial_document_in_pname, comercial_document_in.status as
     * comercial_document_in_status, comercial_document_in.supply_date as
     * comercial_document_in_supply_date, contract.id as
     * contract_id,contract.pkey as contract_pkey,contract.pname as
     * contract_pname, program_base_time_period.id as
     * program_base_time_period_id, program_base_time_period.pkey as
     * program_base_time_period_pkey, base_time_period.id as
     * base_time_period_id, base_time_period.pkey as base_time_period_pkey,
     * program.id as program_id, program.pkey as program_pkey,program.pname as
     * program_pname, third_person.id as third_person_id, third_person.pkey as
     ...
     * comercial_document_type_pname FROM comercial_document_in, contract_in as
     * contract, program_base_time_period as program_base_time_period,
     * base_time_period as base_time_period, program as program, third_person as
     * third_person, user_lon as user_autor, comercial_document_type_in as
     * comercial_document_type WHERE comercial_document_in.contract_id =
     * contract.id AND contract.program_base_time_period_id =
     * program_base_time_period.id AND
     * program_base_time_period.base_time_period_id = base_time_period.id AND
     * program_base_time_period.program_id = program.id AND
