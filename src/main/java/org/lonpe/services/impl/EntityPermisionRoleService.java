...
public class EntityPermisionRoleService extends AbstractServiceLon<EntityPermisionRole> {
    ...
    /**
     * private static String sql00 = "SELECT entity_permision_role.id as
     * entity_permision_role_id, entity_permision_role.pkey as
     * entity_permision_role_pkey, entity_permision_role.enabled as
     * entity_permision_role_enabled, entity_permision_role.nombre as
     * entity_permision_role_nombre, entity_permision_role.permission as
     * entity_permision_role_permission, role.id as role_id,role.pkey as
     * role_pkey,role.pname as role_pname FROM entity_permision_role, role as
     * role WHERE entity_permision_role.role_id = role.id; "
     */
    @Override
