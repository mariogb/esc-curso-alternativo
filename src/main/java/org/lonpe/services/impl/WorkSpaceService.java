...
public class WorkSpaceService extends AbstractServiceLon<WorkSpace> {
     ...
     * work_space.pkey as work_space_pkey, work_space.capacity as
     * work_space_capacity, work_space.pname as work_space_pname,
     * work_space.type as work_space_type, work_space_group.id as
     * work_space_group_id,work_space_group.pkey as
     * work_space_group_pkey,work_space_group.pname as work_space_group_pname,
     * base.id as base_id, base.pkey as base_pkey,base.pname as base_pname FROM
     * work_space, work_space_group as work_space_group, base as base WHERE
...
//[2] base --   base
    ...
    private int fillXRow0(final Row r, final XSSFRow row, int nc, final boolean withIds) {
        ...
        lToCell(r, row, "work_space_capacity", nc++);     //pname       
