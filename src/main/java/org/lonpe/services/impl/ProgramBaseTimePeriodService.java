...
public class ProgramBaseTimePeriodService extends AbstractServiceLon<ProgramBaseTimePeriod> {
    ...
    /**
     * private static String sql00 = "SELECT program_base_time_period.id as
     ...
     * FROM program_base_time_period, base_time_period as base_time_period, base
     * as base, time_period as time_period, program as program WHERE
     ...
     * time_period.id AND program_base_time_period.program_id = program.id; "
     */
    @Override
