...
public class WorkSpaceGroupService extends AbstractServiceLon<WorkSpaceGroup> {
    ...
    /**
     * private static String sql00 = "SELECT work_space_group.id as
     * work_space_group_id, work_space_group.pkey as work_space_group_pkey,
     * work_space_group.pname as work_space_group_pname,
     * work_space_group.type_lon as work_space_group_type_lon, base.id as
     * base_id,base.pkey as base_pkey,base.pname as base_pname FROM
     * work_space_group, base as base WHERE work_space_group.base_id = base.id;
     * "
     */
    @Override
