...
public class TimePeriodService extends AbstractServiceLon<TimePeriod> {
     ...
     * time_period.pkey as time_period_pkey, time_period.begin_date as
     * time_period_begin_date, time_period.end_date as time_period_end_date,
     * time_period.pname as time_period_pname, time_period.type_lon as
     * time_period_type_lon FROM time_period ; "
     */
    @Override
