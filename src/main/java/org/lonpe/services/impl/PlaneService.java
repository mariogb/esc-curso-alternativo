...
public class PlaneService extends AbstractServiceLon<Plane> {
    ...
    /**
     * private static String sql00 = "SELECT plane.id as plane_id, plane.pkey as
     * plane_pkey, plane.plate as plane_plate, plane.pname as plane_pname,
     * plane.seats as plane_seats, la_compania.id as
     * la_compania_id,la_compania.pkey as la_compania_pkey,la_compania.pname as
     * la_compania_pname FROM plane, air_company as la_compania WHERE
