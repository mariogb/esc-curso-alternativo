...
public class PaymentOutTypeService extends AbstractServiceLon<PaymentOutType> {
    ...
    /**
     * private static String sql00 = "SELECT payment_out_type.id as
     * payment_out_type_id, payment_out_type.pkey as payment_out_type_pkey,
     * payment_out_type.pname as payment_out_type_pname FROM payment_out_type ;
     * "
     */
    @Override
