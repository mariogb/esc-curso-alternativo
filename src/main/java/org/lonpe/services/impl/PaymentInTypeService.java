...
public class PaymentInTypeService extends AbstractServiceLon<PaymentInType> {
    ...
    /**
     * private static String sql00 = "SELECT payment_in_type.id as
     * payment_in_type_id, payment_in_type.pkey as payment_in_type_pkey,
     * payment_in_type.pname as payment_in_type_pname FROM payment_in_type ; "
     */
    @Override
