...
public class MonetaryAccountService extends AbstractServiceLon<MonetaryAccount> {
    ...
    /**
     * private static String sql00 = "SELECT monetary_account.id as
     * monetary_account_id, monetary_account.pkey as monetary_account_pkey,
     * monetary_account.pname as monetary_account_pname FROM monetary_account ;
     * "
     */
    @Override
