...
public class ProductService extends AbstractServiceLon<Product> {
     ...
     * product.pkey as product_pkey, product.description as product_description,
     * product.fast_key as product_fast_key, product.pname as product_pname,
     * product.sku as product_sku, product_type.id as
     * product_type_id,product_type.pkey as product_type_pkey,product_type.pname
     * as product_type_pname FROM product, product_type as product_type WHERE
