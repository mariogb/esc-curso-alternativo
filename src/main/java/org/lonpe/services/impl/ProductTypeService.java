...
public class ProductTypeService extends AbstractServiceLon<ProductType> {
     ...
     * product_type.pkey as product_type_pkey, product_type.afect_stock as
     * product_type_afect_stock, product_type.description as
     * product_type_description, product_type.fast_key as product_type_fast_key,
     * product_type.is_service as product_type_is_service, product_type.pname as
     * product_type_pname, product_type.taxable as product_type_taxable,
     * product_type.with_serial_number as product_type_with_serial_number FROM
     * product_type ; "
     */
    @Override
