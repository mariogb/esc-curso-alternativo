...
public class PaymentInService extends AbstractServiceLon<PaymentIn> {
     ...
     * payment_in.pkey as payment_in_pkey, payment_in_form.id as
     * payment_in_form_id,payment_in_form.pkey as payment_in_form_pkey,
     * monetary_account.id as monetary_account_id, monetary_account.pkey as
     * monetary_account_pkey,monetary_account.pname as monetary_account_pname,
     * payment_in_type.id as payment_in_type_id, payment_in_type.pkey as
     * payment_in_type_pkey,payment_in_type.pname as payment_in_type_pname,
     * comercial_document_in.id as
     * comercial_document_in_id,comercial_document_in.pkey as
     * comercial_document_in_pkey,comercial_document_in.pname as
     * comercial_document_in_pname, contract.id as contract_id, contract.pkey as
     ...
     * comercial_document_type_pname FROM payment_in, payment_in_form as
     * payment_in_form, monetary_account as monetary_account, payment_in_type as
     * payment_in_type, comercial_document_in as comercial_document_in,
     * contract_in as contract, program_base_time_period as
     * program_base_time_period, third_person as third_person, user_lon as
     * user_autor, comercial_document_type_in as comercial_document_type WHERE
     * payment_in.payment_in_form_id = payment_in_form.id AND
     * payment_in_form.monetary_account_id = monetary_account.id AND
     * payment_in_form.payment_in_type_id = payment_in_type.id AND
     * payment_in.comercial_document_in_id = comercial_document_in.id AND
     * comercial_document_in.contract_id = contract.id AND
     * contract.program_base_time_period_id = program_base_time_period.id AND
     * contract.third_person_id = third_person.id AND
     * comercial_document_in.user_autor_id = user_autor.id AND
     * comercial_document_in.comercial_document_type_id =
     * comercial_document_type.id; "
     */
    @Override
