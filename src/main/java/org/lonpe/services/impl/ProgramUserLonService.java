...
public class ProgramUserLonService extends AbstractServiceLon<ProgramUserLon> {
    ...
    /**
     * private static String sql00 = "SELECT program_user_lon.id as
     * program_user_lon_id, program_user_lon.pkey as program_user_lon_pkey,
     * program.id as program_id,program.pkey as program_pkey,program.pname as
     * program_pname, user_lon.id as user_lon_id,user_lon.pkey as
     * user_lon_pkey,user_lon.pname as user_lon_pname FROM program_user_lon,
     * program as program, user_lon as user_lon WHERE
     * program_user_lon.program_id = program.id AND program_user_lon.user_lon_id
     * = user_lon.id; "
     */
    @Override
