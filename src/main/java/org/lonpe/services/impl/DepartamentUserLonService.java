...
public class DepartamentUserLonService extends AbstractServiceLon<DepartamentUserLon> {
    ...
    /**
     * private static String sql00 = "SELECT departament_user_lon.id as
     * departament_user_lon_id, departament_user_lon.pkey as
     * departament_user_lon_pkey, departament.id as
     * departament_id,departament.pkey as departament_pkey,departament.pname as
     * departament_pname, user_lon.id as user_lon_id,user_lon.pkey as
     * user_lon_pkey,user_lon.pname as user_lon_pname FROM departament_user_lon,
     * departament as departament, user_lon as user_lon WHERE
     * departament_user_lon.departament_id = departament.id AND
     * departament_user_lon.user_lon_id = user_lon.id; "
     */
    @Override
