...
CREATE TABLE alumno  (  id bigint DEFAULT nextval('alumno_id_seq'::regclass) NOT NULL ,
 pkey VARCHAR(32)  NOT NULL  ,
 activo Boolean  NOT NULL  ,
 pname VARCHAR(64)  NOT NULL  ,
 primer_apellido VARCHAR(64)  NOT NULL  ,
 segundo_apellido VARCHAR(64)  NOT NULL    );      
CREATE UNIQUE INDEX alumno_udix_id ON public.alumno USING btree (id);


CREATE UNIQUE INDEX alumno_uidx_pkey ON public.alumno USING btree (pkey);
-- INDEX FOR PC  pname 
CREATE INDEX alumno_idx_pname ON public.alumno USING btree (pname);
 

    
--- TABLE  Materia 

CREATE TABLE materia  (  id bigint DEFAULT nextval('materia_id_seq'::regclass) NOT NULL ,
 pkey VARCHAR(32)  NOT NULL  ,
 activo Boolean  NOT NULL  ,
 pname VARCHAR(64)  NOT NULL    );      
CREATE UNIQUE INDEX materia_udix_id ON public.materia USING btree (id);


CREATE UNIQUE INDEX materia_uidx_pkey ON public.materia USING btree (pkey);
-- INDEX FOR PC  pname 
CREATE INDEX materia_idx_pname ON public.materia USING btree (pname);
 

    
--- TABLE  Calificacion 

CREATE TABLE calificacion  (  id bigint DEFAULT nextval('calificacion_id_seq'::regclass) NOT NULL ,
 pkey VARCHAR(32)  NOT NULL  ,
 calificacion numeric(16,6)  NOT NULL  ,
 fecha Date  NOT NULL  ,
 alumno_id bigint  NOT NULL,
 materia_id bigint  NOT NULL  );      
CREATE UNIQUE INDEX calificacion_udix_id ON public.calificacion USING btree (id);


CREATE UNIQUE INDEX calificacion_uidx_pkey ON public.calificacion USING btree (pkey);
...
-- Foreign keys for  Calificacion  calificacion   
...
ADD CONSTRAINT fk_calificacion_xx_alumno_id
FOREIGN KEY (alumno_id)
REFERENCES "public"."alumno"(id);   

--   To: materia materia_id

ALTER TABLE "public"."calificacion"
ADD CONSTRAINT fk_calificacion_xx_materia_id
...
-- VIEW FOR   Alumno
Select '
Create view for Alumno' as dc;
CREATE OR REPLACE VIEW alumno_view as 
SELECT alumno.id as alumno_id,
alumno.pkey as alumno_pkey,
alumno.activo as alumno_activo,
alumno.pname as alumno_pname,
...
-- VIEW FOR   Materia
Select '
Create view for Materia' as dc;
CREATE OR REPLACE VIEW materia_view as 
SELECT materia.id as materia_id,
materia.pkey as materia_pkey,
materia.activo as materia_activo,
materia.pname as materia_pname 
  FROM 
  materia ; 



-- VIEW FOR   Calificacion
Select '
Create view for Calificacion' as dc;
CREATE OR REPLACE VIEW calificacion_view as 
SELECT calificacion.id as calificacion_id,
calificacion.pkey as calificacion_pkey,
calificacion.calificacion as calificacion_calificacion,
calificacion.fecha as calificacion_fecha,
alumno.id as alumno_id,alumno.pkey as alumno_pkey,alumno.pname as alumno_pname,
materia.id as materia_id,materia.pkey as materia_pkey,materia.pname as materia_pname 
  FROM 
  calificacion,
  alumno as alumno,
  materia as materia  
 ...
 AND calificacion.materia_id = materia.id; 
